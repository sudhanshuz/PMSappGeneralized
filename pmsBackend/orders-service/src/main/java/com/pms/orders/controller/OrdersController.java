...
public class OrdersController {
	...
	@GetMapping("/getPickedUpOrderById/{orderId}")
	public Optional<PickedUpOrders> getPickedUpOrderById(@PathVariable long orderId ) {
		return pickedUpOrdersRepo.findById(orderId);
	}
	
	@Autowired
    public OrdersController(OrdersService emailService) {
        this.ordersService = emailService;
    }
